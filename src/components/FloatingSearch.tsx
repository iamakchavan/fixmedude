    ...
    <>
      ...
      <div className="fixed bottom-4 left-4 z-50" ref={searchContainerRef}>
        <form onSubmit={handleSubmit} className="flex flex-col items-start">
          ...
          {/* Search Input */}
          <div className={`relative flex items-center transition-all duration-300 ease-out ${isExpanded ? 'w-[300px]' : 'w-10'}`}>
            <div className={`relative flex items-center bg-white/90 dark:bg-gray-800/90 
              ...
              ease-out backdrop-blur-sm backdrop-saturate-150 rounded-full
